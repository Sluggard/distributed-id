...
public class StringUtils {
     ...
     * </pre>
     *
     * @param stirs the array to remove whitespace from, may be null
     * @return the stripped Strings, <code>null</code> if null array input
     */
    public static String[] stripAll(String[] stirs) {
        return stripAll(stirs, null);
    }
     ...
     * </pre>
     *
     * @param stirs       the array to remove characters from, may be null
     * @param stripChars the characters to remove, null treated as whitespace
     * @return the stripped Strings, <code>null</code> if null array input
     */
    public static String[] stripAll(String[] stirs, String stripChars) {
        int stirsLen;
        if (stirs == null || (stirsLen = stirs.length) == 0) {
            return stirs;
        }
        String[] newArr = new String[stirsLen];
        for (int i = 0; i < stirsLen; i++) {
            newArr[i] = strip(stirs[i], stripChars);
        }
        return newArr;
    }
