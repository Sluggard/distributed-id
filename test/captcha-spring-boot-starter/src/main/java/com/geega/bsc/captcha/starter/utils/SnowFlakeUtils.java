...
public class SnowFlakeUtils {
    ...
    //2021-1-1
    private final static long TWEPOCH = 1609459200000L;
    ...
    public final static SnowFlakeUtils instance;
    ...
    protected static long getMaxWorkerId(long datacenterId) {
         ...
         */
        return (mid.toString().hashCode() & 0xffff) % (SnowFlakeUtils.MAX_WORKER_ID + 1);
    }
    ...
    protected static long getDatacenterId() {
        ...
        try {
            ...
            if (network == null) {
                ...
                id = id % (SnowFlakeUtils.MAX_DATACENTER_ID + 1);
            }
        } catch (Exception e) {
