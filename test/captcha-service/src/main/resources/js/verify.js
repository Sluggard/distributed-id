...
//            contentType: "application/json;charset=UTF-8",
            url: baseUrl + "/api/v1/captcha/get" + "?" + "captchaType=" + data,
            cache: false,
    ...
    function checkPictrue(data, baseUrl, resolve, reject) {
        $.ajax({
            type: "post",
            contentType: "application/json;charset=UTF-8",
            url: baseUrl + "/api/v1/captcha/check",
    ...
    Slide.prototype = {
        ...
        refresh: function () {
            ...
            this.isEnd = false;
            getPictrue(
            "blockPuzzle", this.options.baseUrl, function (res) {
                if (res.code == "0000") {
                    _this.$element.find(".backImg")[0].src = 'data:image/png;base64,' + res.data.originalImageBase64
                    console.info(res.data.originalImageBase64);
                    _this.$element.find(".bock-backImg")[0].src = 'data:image/png;base64,' + res.data.jigsawImageBase64
                    console.info(res.data.jigsawImageBase64);
    ...
    Points.prototype = {
        ...
        refresh: function () {
            ...
            this.num = 1;
            getPictrue(
            "clickWord", _this.options.baseUrl, function (res) {
                if (res.code == "0000") {
                    _this.htmlDoms.back_img[0].src = 'data:image/png;base64,' + res.data.originalImageBase64;
                    console.info(res.data.originalImageBase64);
                    _this.backToken = res.data.token;
                    _this.secretKey = res.data.secretKey;
                    var text = '请依次点击';
                    if (res.data != null && res.data.wordList != null && res.data.wordList.length > 0) {
